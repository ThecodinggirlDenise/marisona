    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/our-story" element={<OurStory />} />  {/* Update these paths as needed */}
          <Route path="/how-it-works" element={<HowItWorks />} />
          <Route path="/products" element={<Product/>} />
          <Route path="/contact" element={<ContactUs />} />
          <Route path="/fqa" element={<Accordion/>} />
          <Route path="/blog" element={<Blog />} />
          <Route path="/blogs/ultrasonic-antifouling-system" element={<UltrasonicAntiFouling />} />
          <Route path="/blogs/marine-biofouling" element={<MarineBiofouling />} />
          <Route path="/privacy-policy" element={<PrivacyPolicy/>} />
        <Route path="/terms-of-service"element={<PrivacyPolicy/>} />
        <Route path="/testimonials" element={<Testimonials />} /> {/* Add this line */}
        </Routes>
        <Footer />
      </div>
    </Router>
