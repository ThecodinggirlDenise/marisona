...
const resources = {
  en: {
    translation: {
      ...
      BF: "Get a Special Pricing for Your Vessels!",
      BPriceF: "Get a quote",
      MoreAbUs: "More About Us",
      IC: "Contact Us",
      ICP: " You can contact us to protect your boat with Marisonia's innovative technology. Afterwards, our team will get in touch with you.",
      N: "Name",
      S: "Surname",
      P: "Phone",
      E: "E-mail",
      ...
      BPP: "To seize the opportunity to become a part of this innovative product by establishing a business partnership with Marisonia, please fill out the form below. Our team will contact you as soon as possible through your provided contact information.",
      COMAST: "Components of the Marisonia Anti-Fouling System",
      COMASTC:
        "Marisonia conducts ultrasonic frequency scanning on the transducers within the range of 20-60 kHz",
      PSSAP: "Power Supply Specifications and Protection",
      PSSAPC:
        "Marisonia conducts ultrasonic frequency scanning on the transducers within the range of 20-60 kHz.",
      PSSAPC1:
      ...
      ECMPU: "Energy Consumption and Maximum Power Usage",
      ECMPUC: "On average, the product consumes 6W.",
      LED: "LED Indicators for Operational Status",
      LEDC: "Marisonia features Power and Info LEDs. The Power LED illuminates in green when the DC-DC converter on the card produces an output. The Info LED flashes in red at different intervals to indicate the connection status of the transducers.",
      DS: "Device Size",
      DSC: "Marisonia's control box weighs 800 grams and measures 20x16x6 cm. Each transducer mounted on the boat hull weighs 430 grams and has dimensions of 6x8 cm.",
      MOVRWM: "Map of Vessels Equipped with Marisonia",
      MOVRWMC:
      ...
      FQA1: "Frequently Asked Questions",
      FAQC: "We provide answers to common questions about Marisonia's anti-fouling system and related topics. If you have a question that isn't addressed here, please feel free to contact us for further assistance.",
      Q1: "What is Marisonia?",
      A1: "Marisonia is a system specifically designed to prevent biofouling on ship hulls. It operates by emitting constant ultrasonic waves, creating vibrations on the hull that are imperceptible to humans and marine life. These vibrations effectively prevent the formation of algae, which is the initial stage in the marine biofouling process.",
      Q2: "What is antifouling?",
      A2: "Antifouling refers to the various methods used to prevent biofouling on ship hulls. Many of the current antifouling techniques are inefficient and can be detrimental to diverse marine ecosystems. A prevalent method involves coating the submerged part of a ship's hull with toxic paints. However, this approach not only poses a threat to marine life but also tends to be ineffective in the long term at preventing biofouling.",
      Q3: "Why is antifouling so important?",
      A3: "Antifouling is crucial as it significantly reduces maintenance costs and lowers fuel expenditure by preventing biofouling that causes drag. It also reduces the need for frequent hull cleaning, saving both time and labor",
      Q4: "How does Marisonia work?",
      A4: "Marisonia functions by converting electrical energy into ultrasonic waves. The system consists of a control box that generates these ultrasonic waves, coupled with transducers that emit them onto the ship's hull. These transducers are professionally installed inside the hull by authorized technicians which means there will be no visible change in the appearance of the vessel. To maintain its efficacy, the system needs to be operational continuously.",
      Q5: "Does Marisonia’s ultrasonic antifouling technology work on all types of material?",
      A5: "Marisonia is not effective on all types of materials. It is designed to work on hulls made of fiberglass, steel, aluminium, and iron. However, it is not suitable for wooden hulls.",
      Q6: "How much power does the Marisonia ultrasonic antifouling system consume?",
      A6: "The system is designed to be environmentally friendly, which includes its power consumption. It consumes ~6W on average.",
      Q7: "Does Marisonia disturb fish and/or marine mammals?",
      A7: "No, the waves emitted through Marisonia are not an audible sound for fish and marine mammals. The waves emitted are much less powerful than commonly used fish finders and sonar systems.",
      Q8: "What is ultrasonic antifouling technology?",
      A8: "Ultrasonic antifouling technology prevents marine organisms like algae and barnacles from accumulating on submerged boat and ship surfaces. This method works by emitting low-frequency ultrasonic waves, producing small vibrations on the hull's surface. These vibrations deter the attachment and growth of marine life, thus minimizing the necessity for regular hull cleaning and the use of potentially damaging chemical antifouling treatments.",
      Q9: "How easy is it to install an ultrasonic antifouling system?",
      A9: "Yes, it is easy to install Marisonia. It is strictly advised that the system is installed by authorized personnel for the best possible solution. Depending on the size of the ship (and the number of transducers to be installed) it might take up to a couple of hours to completely finish the installation process.",
      Q10: "Does ultrasonic antifouling work in freshwater environments?",
      A10: "Yes, Marisonia can work in freshwater environments as well.",
      Q11: "What maintenance is required for ultrasonic antifouling systems?",
      A11: "Marisonia typically does not require regular maintenance under normal conditions. However, if issues arise with any component of the system, such as the control box, transducers, or cables, your dealer will assist with the necessary repair services.",
      Q12: "Does Marisonia come with a warranty?",
      A12: "Yes, Marisonia comes with a 2-year manufacturer guarantee.",
      Q13: "Will the application of antifouling paints continue?",
      A13: "Using Marisonia alongside antifouling paints enhances the protection of the boat. Marisonia extends the life of current antifouling applications and reduces the frequency of docking. Concurrently, it is also possible and effective to use it without applying toxic paint. The performance of non-toxic paint usage varies depending on the boat's fiber thickness, frequency of use, speed, and the sea it is located in.",
      Q14: "Can the customer install the product themselves?",
      A14: "No. For the product to function correctly and effectively, it must be installed by authorized personnel.",
      Q15: "Does the boat's bottom need to be clean for Marisonia installation?",
      A16: "The product can be installed at any time, and it is not mandatory for the boat's bottom to be clean. If biological growth is present on the boat’s underside at the time of installation, it will not remove this buildup but will slow its progression. For the product's effectiveness to be fully observed, the boat's bottom needs to be clean.",
    },
  },
  tr: {
    translation: {
      ...
      BF: "Tekneniz için Özel Fiyat Alın!",
      BPriceF: "Fiyat Teklifi Alın",
      MoreAbUs: "Hakkımızda Daha Fazlası",
      IC: "Bize Ulaşın",
      ICP: "Teknenizi Marisonia'nın öncü teknolojisiyle korumaya almak istiyorsanız, bizimle iletişime geçin. Talebiniz üzerine, ekibimiz en kısa sürede sizinle iletişim kuracaktır.",
      N: "Adı",
      S: "Soyadı",
      P: "Telefon",
      E: "E-Posta",
      ...
      BM: "Gövde Malzemesi",
      TM: "Kısa Mesaj",
      BP: "İş Ortağımız Olun",
      BPP: "Marisonia ile iş ortaklığı kurarak bu yenilikçi çözümün bir parçası olma fırsatını yakalamak için lütfen aşağıdaki formu doldurunuz. İletişim bilgileriniz üzerinden ekibimiz en kısa sürede sizinle iletişim kuracaktır.",
      COMAST: "Marisonia Kirlenme Önleyici Sistemin Bileşenleri",
      COMASTC:
        "Marisonia kirlenme önleyici sistemi kontrol kutusu, dönüştürücüler ve kablolardan oluşur. Kullanılacak dönüştürücü sayısı teknenin uzunluğuna göre değişiklik gösterebilir.",
      PSSAP: "Ultrasonik Frekans Tarama Aralığı",
      PSSAPC:
        "Marisonia, dönüştürücüler üzerinde 20-60 kHz aralığında ultrasonik frekans taraması yapar.",
      PSSAPC1:
        "Ürün 12/24V güç kaynağı ile çalışabilmektedir. Ters voltaj durumunda ürün hasar görmez. Kısa devre koruması için değiştirilebilir bir sigorta ile donatılmıştır.",
      ECMPU: "Enerji Tüketimi ve Maksimum Güç Kullanımı",
      ECMPUC: "Marisonia ortalama 6W güç tüketmektedir.",
      LED: "Çalışma Durumuna İlişkin LED Göstergeler",
      LEDC: "Marisonia'da Güç ve Bilgi LED'leri bulunur. Kart üzerinde bulunan DC-DC dönüştürücü çıkış ürettiğinde Power LED’i yeşil renkte yanar. Bilgi LED'i, dönüştürücülerin bağlantı durumunu göstermek için farklı aralıklarla kırmızı renkte yanıp söner.",
      DS: "Cihaz Boyutları",
      DSC: "Marisonia’nın kontrol kutusu 800gr ağırlığındadır ve 20x16x6 cm ölçülerindedir. Tekne gövdesine monte edilen transdüserlerin ise her biri 430gr ağırlığındadır ve 6x8cm ölçülerindedir.",
      MOVRWM: "Marisonia ile Donatılmış Teknelerin Haritası",
      MOVRWMC:
        "Bu harita, Marisonia cihazı ile donatılmış tekneleri gerçek zamanlı olarak gösterir. Çeşitli bölgelerde bulunan tekneleri takip edebilirsiniz. Marisonia ile donatılmış tekneler, denizde güvenli ve verimli bir seyir deneyimi sağlayan ileri teknoloji sensörlerle donatılmıştır.",
      FQA1: "Kirlenme Önleyici Sistem Hakkında Sıkça Sorulan Sorular",
      FAQC: "Marisonia'nın kirlenme önleyici sistemi ve ilgili konular hakkındaki sık sorulan sorulara yanıtlar sağlıyoruz. Burada ele alınmayan bir sorunuz varsa, daha fazla yardım için lütfen bizimle iletişime geçmekten çekinmeyin.",
      Q1: "Marisonia Nedir?",
      A1: "Marisonia, gemi gövdelerinde biyolojik kaplanmayı önlemek için özel olarak tasarlanmış bir ultrasonik antifouling sistemidir. Sürekli ultrasonik dalgalar yayarak çalışır ve bu dalgalar, insanlar ve deniz canlıları tarafından algılanamayan gövde üzerinde titreşimler oluşturur. Bu titreşimler, deniz biyolojik kaplanma sürecinin ilk aşaması olan alg oluşumunu etkili bir şekilde önler.",
      Q2: "Antifouling nedir?",
      A2: "Antifouling, gemi gövdelerinde deniz biyolojik kaplanmasını önlemek için kullanılan çeşitli yöntemlere verilen isimdir. Mevcut antifouling tekniklerinin birçoğu verimsizdir ve çeşitli deniz ekosistemlerine zarar verebilir. Yaygın bir yöntem, geminin su altında kalan kısmını toksik boyalarla kaplamayı içerir. Ancak, bu yaklaşım sadece deniz yaşamı için bir tehdit oluşturmakla kalmaz, aynı zamanda uzun vadede tekne altında biyolojik oluşumları önlemede de etkisiz olma eğilimindedir.",
      Q3: "Antifouling neden bu kadar önemli? ",
      A3: "Antifouling, sürüklenmeye neden olan biyolojik kaplanmayı önleyerek tekne bakım maliyetlerini önemli ölçüde azaltır ve yakıt harcamalarını düşürür. Ayrıca, sık sık gövde temizliğine olan ihtiyacı azaltarak hem zaman hem de iş gücünden tasarruf sağlar.",
      Q4: "Marisonia nasıl çalışır?",
      A4: "Marisonia, elektrik enerjisini ultrasonik dalgalar haline dönüştürerek çalışır. Sistem, bu ultrasonik dalgaları üreten bir kontrol kutusu ve bu dalgaları geminin gövdesine yayan dönüştürücülerden oluşur. Bu dönüştürücüler, yetkili teknisyenler tarafından gövde içine profesyonelce monte edilir, bu da geminin görünüşünde herhangi bir değişiklik olmayacağı anlamına gelir. Sistemin etkinliğini korumak için sürekli olarak çalışır durumda olması gereklidir.",
      Q5: "Marisonia'nın ultrasonik antifouling teknolojisi her türlü gövde de işe yarar mı?",
      A5: "Marisonia, her türlü malzemede etkili değildir. Fiberglas, çelik, alüminyum ve demirden yapılmış gövdelerde çalışacak şekilde tasarlanmıştır. Ancak, ahşap gövdeler için uygun değildir.",
      Q6: "Marisonia ultrasonik antifouling sistemi ne kadar elektrik/güç tüketir?",
      A6: "Sistem, güç tüketimi de dahil olmak şekilde çevre dostu olarak tasarlanmıştır. Ortalama olarak ~6W enerji tüketimi yapmaktadır. Bu oldukça düşük bir rakamdı.",
      Q7: "Marisonia balıkları ve/veya deniz memelilerini rahatsız eder mi?",
      A7: "Hayır, Marisonia aracılığıyla yayılan dalgalar, balıklar ve deniz memelileri için işitilebilir bir ses değildir. Marisonia'ın ürettiği dalgalar balık bulucu ve sonar sistemlerden daha güçsüzdür.",
      Q8: "Ultrasonik antifouling teknolojisi nedir?",
      A8: "Ultrasonik antifouling teknolojisi, algler, yosunlar ve midyeler gibi deniz organizmalarının su altında kalan tekne ve gemi yüzeylerinde birikmesini önler. Bu yöntem, düşük frekanslı ultrasonik dalgalar yayarak çalışır ve bu, gövdenin yüzeyinde küçük titreşimler üretir. Bu titreşimler, deniz yaşamının yapışmasını ve büyümesini engeller, böylece düzenli gövde temizliğine ve potansiyel olarak zararlı kimyasal antifouling tedavilerine olan ihtiyacı en aza indirir.",
      Q9: "Ultrasonik antifouling sistemi kurmak ne kadar kolaydır?",
      A9: "Evet, Marisonia'nın kurulumu kolaydır. Sistemin en iyi şekilde çözüm sağlaması için yetkili bir personel tarafından kurulması şiddetle tavsiye edilir. Geminin boyutuna (dolayısıyla kurulacak dönüştürücü miktarına) bağlı olarak, kurulum işleminin tamamlanması birkaç saat sürebilir.",
      Q10: "Ultrasonik antifouling tatlı su ortamlarında çalışır mı?",
      A10: "Evet, Marisonia tatlı su ortamlarında da çalışabilir.",
      Q11: "Ultrasonik antifouling sistemleri için hangi bakım gereklidir?",
      A11: "Marisonia, normal koşullar altında düzenli bakım gerektirmez. Ancak, sistemin herhangi bir bileşeniyle (kontrol kutusu, dönüştürücüler veya kablolar gibi) ilgili sorunlar ortaya çıkarsa, bayiniz gerekli tamir hizmetleriyle yardımcı olacaktır.",
      Q12: "Marisonia’nın garantisi var mı?",
      A12: "Evet, Marisonia 2 yıllık üretici garantisi ile birlikte sunulmaktadır.",
      Q13: "Zehirli boya uygulamasına devam edilecek mi?",
      A13: "Marisonia ile zehirli boyanın aynı anda kullanılması teknenin korumasını artırmaktadır. Marisonia mevcut durumda kullanılan kirlenme önleyici uygulamaların ömrünü uzatmakta ve karaya çıkma sıklığını azaltmaktadır. Bu durumun paralelinde, zehirli boya sürmeden kullanım da mümkündür ve etkilidir. Zehirli boyasız kullanım performansı; teknenin fiber kalınlığı, kullanılma sıklığı, sürati ve bulunduğu denize göre değişmektedir. ",
      Q14: "Satın alan kişi ürün kurulumunu kendisi yapabilir mi?",
      A14: "Hayır. Ürünün doğru ve etkili çalışması için yetkili personel tarafından kurulması gerekmektedir",
      Q15: "Marisonia takılırken teknenin altı temiz mi olmalı?",
      A15: "Ürünün montajı herhangi bir zaman gerçekleştirilebilir, teknenin altının temiz olması zorunlu değildir. Montaj yapıldığında, eğer tekne altında biyolojik oluşum varsa, bu birikimi temizlemez, ancak gelişmesini yavaşlatır. Ürünün etkinliğinin tam olarak görülebilmesi için, teknenin altının temiz olması gerekmektedir",
    },
  },
};
