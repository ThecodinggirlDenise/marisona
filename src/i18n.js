...
const resources = {
  en: {
    translation: {
      ...
      "Efficient and seamless ride on the water; conserves fuel, extends maintenance interval": "Efficient and seamless ride on the water; conserves fuel, extends maintenance interval",
      "Get a Special Pricing for Your Vessels!": "Get a Special Pricing for Your Vessels!",
     ...
     "MS5-2":" While conventional anti-fouling methods, such as utilizing toxic anti-fouling paints or biocide agents, can mitigate the impact of these organisms, embracing advanced technologies presents an environmentally sound and efficient alternative. This innovative approach aligns well with evolving regulatory frameworks, ensuring a more sustainable solution for mitigating biofouling.",
     ...
     "Eco-Friendly": "Eco-Friendly",
      ...
      "Reduces fuel consumption by up to 30%. Prevents the increase of friction force on the boat by preventing marine organisms from adhering to the boat hull and gear.": "Reduces fuel consumption by up to 30%. Prevents the increase of friction force on the boat by preventing marine organisms from adhering to the boat hull and gear.",
      "MS9": "Easy to Install",
      ...
      "Marisonia from Customer Perspective": "Marisonia from Customer Perspective",
      "Get a Quote": "Get a Quote",
      "I have had Marisonia installed on my boat for almost a year now, and the difference is very clear compared to the boats moored next to me in Bitez. While mold and algae are visibly accumulating on the neighboring boats, my hull remains very clean.": "I have had Marisonia installed on my boat for almost a year now, and the difference is very clear compared to the boats moored next to me in Bitez. While mold and algae are visibly accumulating on the neighboring boats, my hull remains very clean.",
      "I cleaned the bottom of my boat and applied antifouling paint. 2 months later, Marisonia was installed. When my boat was taken out of the water 6 months after that, the condition of the bottom was very impressive. I will continue this season without cleaning the bottom.": "I cleaned the bottom of my boat and applied antifouling paint. 2 months later, Marisonia was installed. When my boat was taken out of the water 6 months after that, the condition of the bottom was very impressive. I will continue this season without cleaning the bottom.",
      "My boat spent the winter in Büyükçekmece Marina, Istanbul. Marisonia has been active for a full year. The view captured by the marina diver was wonderful. Normally, algae reaching almost arm's length were not visible.": "My boat spent the winter in Büyükçekmece Marina, Istanbul. Marisonia has been active for a full year. The view captured by the marina diver was wonderful. Normally, algae reaching almost arm's length were not visible.",
      ...
      "We're a professional team offering": "We're a professional team offering",
      "Rapid Response Guarantee": "Rapid Response Guarantee",
      "We pride ourselves on swift response times, ensuring you get the anti-fouling protection you need without delay.": "We pride ourselves on swift response times, ensuring you get the anti-fouling protection you need without delay.",
      "Made-to-Measure Solutions": "Made-to-Measure Solutions",
      "Doubles the time to haul out your boat, allowing you to have more time to enjoy your boat.": "Doubles the time to haul out your boat, allowing you to have more time to enjoy your boat.",
      "Direct, Personalized Support": "Direct, Personalized Support",
      "Experience one-on-one attention from our team, dedicated to meeting your specific requirements.": "Experience one-on-one attention from our team, dedicated to meeting your specific requirements.",
      "2-years Warranty": "2-years Warranty",
      "With a comprehensive 2-year warranty, we stand by the durability and quality of our in-house manufactured anti-fouling system, ensuring long-lasting performance.": "With a comprehensive 2-year warranty, we stand by the durability and quality of our in-house manufactured anti-fouling system, ensuring long-lasting performance.",
...
"LHB":"Unveiling the Necessity for Uninterrupted Quality Time on Your Boat"
  ...
  tr: {
    translation: {
      ...
      "Ultrasonic Anti-Fouling System": "Yeni Nesil Tekne Altı Kirlenme Önleyici Sistem",
      "Efficient and seamless ride on the water; conserves fuel, extends maintenance interval": "Su üzerinde verimli ve kesintisiz sürüş; Yakıt tasarrufu sağlar, bakım gereksinimini uzatır",
      "Get a Special Pricing for Your Vessels!": "Tekneniz için Özel Fiyat Alın!",
      ...
      "Marisonia: The Shield Your Boat Deserves": "Marisonia: Teknenizin Hak Ettiği Kalkan",
      ...
      ,"MS5-2":"Zehirli boyalar veya biyosit maddelerinin kullanılması gibi geleneksel kirlenme önleyici yöntemler bu organizmaların etkisini hafifletebilirken, oysa çevresel açıdan duyarlı bir çözüm için ileri teknolojileri benimsemek gerekir. Marisonia sağlam ve etkili bir alternatiftir. Bu yenilikçi yaklaşım, gelişen düzenleyici çerçevelerle iyi uyum sağlayarak biyolojik kirliliğin azaltılması için daha sürdürülebilir bir çözüm sağlar.",
      ...
      "Reduces fuel consumption by up to 30%. Prevents the increase of friction force on the boat by preventing marine organisms from adhering to the boat hull and gear.": "Yakıt tüketimini %30'a kadar azaltır. Deniz organizmalarının tekne gövdesine ve donanımına yapışmasını önleyerek sürtünme kuvvetinin artmasını engeller.",
      "MS9": "Kurulumu Kolay",
      ...
      "The Marisonia ultrasound transducers are easily affixed to the dry side of the surface to be safeguarded. These transducers generate a minuscule, finely modulated pressure pattern within the water layer directly in contact with the protected surface.": "Marisonia ultrasonik dönüştürücüler, korunacak yüzeyin kuru tarafına kolayca monte edilir. Bu dönüştürücüler, korunan yüzeyle doğrudan temas halinde olan su tabakası içinde çok küçük, ince modüle edilmiş bir basınç deseni oluşturur.",
      "Testimonials": "Referanslar",
      "Marisonia from Customer Perspective": "Kullanıcı Gözünden Marisonia",
      "Get a Quote": "Fiyat Teklif Alın",
      "I have had Marisonia installed on my boat for almost a year now, and the difference is very clear compared to the boats moored next to me in Bitez. While mold and algae are visibly accumulating on the neighboring boats, my hull remains very clean.": "Marisonia'yı tekneye takalı neredeyse bir yıl oldu ve Bitez'de yanımda bağlı teknelere kıyasla fark çok net. Komşu teknelerde küf ve yosunlar gözle görülür şekilde birikmekteyken, benim gövdem çok temiz kalıyor.",
      "I cleaned the bottom of my boat and applied antifouling paint. 2 months later, Marisonia was installed. When my boat was taken out of the water 6 months after that, the condition of the bottom was very impressive. I will continue this season without cleaning the bottom.": "Teknemin altını temizledim ve antifouling boya uyguladım. 2 ay sonra Marisonia kuruldu. 6 ay sonra tekne sudan çıkarıldığında altının durumu çok etkileyiciydi. Bu sezonu altını temizlemeden devam ettireceğim.",
      "My boat spent the winter in Büyükçekmece Marina, Istanbul. Marisonia has been active for a full year. The view captured by the marina diver was wonderful. Normally, algae reaching almost arm's length were not visible.": "Teknem Büyükçekmece Marina, İstanbul'da kış geçirdi. Marisonia bir yıldır aktif durumda. Marina dalgıcı tarafından çekilen görüntü harikaydı. Normalde kol boyuna kadar ulaşan yosunlar görünmüyordu.",
      ...
      "We're a professional team offering": "Ekibimiz En Yüksek Kalite Standartlarında Hizmet Sunar",
      "Rapid Response Guarantee": "Hızlı Geri Dönüş",
      "We pride ourselves on swift response times, ensuring you get the anti-fouling protection you need without delay.": "İhtiyacınız olan kirlenme önleyici korumayı gecikmeden almanızı sağlayan hızlı tepki süreleriyle gurur duyuyoruz.",
      "Made-to-Measure Solutions": "Ölçüye Göre Çözümler",
      "Doubles the time to haul out your boat, allowing you to have more time to enjoy your boat.": "Teknenizi çıkarma süresini iki katına çıkararak teknenizin keyfini çıkarmak için daha fazla zaman ayırmanıza olanak tanır.",
      "Direct, Personalized Support": "Doğrudan, Kişiselleştirilmiş Destek",
      "Experience one-on-one attention from our team, dedicated to meeting your specific requirements.": "Özel gereksinimlerinizi karşılamaya adanmış ekibimizin birebir ilgisini deneyimleyin.",
      "2-years Warranty": "2 Yıl Garanti",
      "With a comprehensive 2-year warranty, we stand by the durability and quality of our in-house manufactured anti-fouling system, ensuring long-lasting performance.": "Marisonia'nın tüm ekipmanını kapsamlı 2 yıllık garantisiyle sunmanın gönül rahatlığını taşıyoruz.",
     "OS1H":"Eko-Denizcilikte Mükemmeliyet Zamanı",
      ...
      ,"HITW2P":"Marisonia, denizcilik sektörü için geliştirilmiş, belirli aralıklarla farklı ses dalgaları yayarak teknenin altına yapışabilecek mikroorganizmaları uzaklaştıran bir sistemdir. Bu sayede yosun oluşumunu ve kabukluların yaşam ortamlarının oluşmasını engeller."
      ,"HITW2H":"Neden Kirlenme Önleyici Sistemlere İhtiyacınız Var?",
      "HITW3P":"Biyolojik kirlilik, deniz organizmalarının doğal yapışma eğilimleri nedeniyle sabit veya demirli gemilere bağlanması ve büyümesidir. Deniz taşıtlarını biyolojik kirlilikten korumak çok önemlidir. Çünkü bu daha yüksek yakıt tüketimine ve bakım gereksinimlerine yol açar. Bu sadece teknenin performansını etkilemekle kalmıyor, aynı zamanda su üzerinde sürüş keyfini de engelliyor. Kirlenme önleyici sistemler, biyolojik kirlilikle ilgili sorunları önleyerek optimum tekne deneyimi sağlamak için gereklidir."
       ,"HITW4H":"Hızı Azaltır",
