...
export default function ContactUs() {
  ...
  return (
    <div className=" flex flex-row w-full  mr-auto items-center justify-center mt-32">
      <div>
      <Tabs
      ...
      >
        ...
        <div className="mt-10">
          <TabsContent
            ...
            } mt-[40px] p-5 rounded-lg transition-colors w-[600px] ml-0 text-black bg-white`}
          >
            <div>
              ...
              <form className="flex gap-5">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <input
                      type="text"
                      placeholder="e.g. Fiberglass, Wood, Alum"
                      className="w-full p-[5px] border border-black rounded-[15px]"
                    />
                  </div>
          ...
          <TabsContent
            ...
            } mt-[40px] p-5 rounded-lg transition-colors w-[60%] ml-0 text-black bg-white`}
          >
            <div>
        ...
        <button
          type="submit"
          className="bg-[#003369] text-white border-none py-[10px] px-[20px] rounded-[17px] w-[30%] h-[50px] cursor-pointer hover:bg-[#0056b3]"
        >
          Send
        </button>
      </div>
      ...
      <div className="mt-10 bg-sky-200 p-5 rounded-lg w-[400px] ml-16 flex flex-col  ">
