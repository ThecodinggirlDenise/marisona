...
export default function Blog() {
  return (
    <div className='flex flex-col items-center justify-center w-full px-4'>
      ...
      <section className='w-full max-w-4xl h-[250px] my-6 mb-12 rounded-[33px] flex justify-center items-center relative overflow-hidden bg-white shadow-md'>
        {/* Background Image */}
        <div
      ...
      <section className='w-full max-w-6xl'>
        <div className='flex flex-wrap justify-center gap-6 p-4 md:p-7 mx-auto'>
          ...
          >
            <img src={"/images/Blog-1.jpg"} alt="Blog 1" className='rounded-[10px] w-full h-auto mb-4' />
            <h3 className='mb-2 text-lg text-black font-semibold'>What is an Ultrasonic Anti-Fouling System?</h3>
            <p className='mb-4 text-base font-normal hover:text-[#002fff]'>
              Marisonia has developed a revolutionary machine technology designed to solve fouling problems
            </p>
          ...
          <Link
            ...
            className='flex flex-col items-center text-center w-full sm:w-[45%] lg:w-[30%] bg-white border border-gray-300 rounded-[21px] shadow-md text-inherit no-underline overflow-hidden p-4'
          >
            <img src={"/images/Blog-2.jpg"} alt="Blog 2" className='rounded-[10px] w-full h-auto mb-4' />
            <h3 className='mb-2 text-lg text-black font-semibold'>Marine Biofouling</h3>
            <p className='mb-4 text-base font-normal hover:text-[#002fff]'>
