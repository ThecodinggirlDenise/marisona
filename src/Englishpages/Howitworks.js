          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-6 h-auto ">
            <div className="flex flex-col">
              <div className="flex flex-col items-center justify-center w-[300px] h-auto bg-white rounded-2xl shadow-md p-6 mb-6">
                ...
                <p className="text-gray-600 text-base">{t("EFP")}</p>
              </div>
              <div className="flex flex-col items-center justify-center w-[300px] h-auto bg-white rounded-2xl shadow-md p-6 mb-6">
                <img
                ...
                <p className="text-gray-600 text-base">{t("IPP")}</p>
              </div>
            </div>
            <div className="flex flex-col sm:-mt-20">
              <div className="flex flex-col items-center justify-center w-[300px] h-auto bg-white rounded-2xl shadow-md p-6 mb-6">
                ...
                <p className="text-gray-600 text-base">{t("EIP")}</p>
              </div>
              <div className="flex flex-col items-center justify-center w-[300px] h-auto bg-white rounded-2xl shadow-md p-6 mb-6">
                <img
                ...
                <p className="text-gray-600 text-base">{t("RCP")}</p>
              </div>
            </div>
            <div className="flex flex-col">
              <div className="flex flex-col items-center justify-center w-[300px] h-auto bg-white rounded-2xl shadow-md p-6 mb-6">
                ...
                <p className="text-gray-600 text-base">{t("NMHFCP")}</p>
              </div>
              <div className="flex flex-col items-center justify-center w-[300px] h-auto bg-white rounded-2xl shadow-md p-6 mb-6">
                <img
                ...
                <p className="text-gray-600 text-base">{t("ILTP")}</p>
              </div>
            </div>
          </div>
        </section>
