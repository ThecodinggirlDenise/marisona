    ...
    <div className='flex flex-col items-center justify-center w-full'>
      ...
      <section className='w-full px-4'>
        <div className='flex flex-col lg:flex-row justify-center shadow-lg w-full lg:w-[1000px] mt-10 rounded-[2rem] lg:rounded-[7rem] overflow-hidden'>
          ...
          <img src='/images/main2.png' className='w-full lg:w-[500px] mt-6 lg:mt-0 object-cover' />
        </div>
      </section>
      ...
      <section className='w-full flex flex-col lg:flex-row justify-center items-center mt-16 lg:mt-36 px-4 font-montserrat'>
        <div className='flex items-center justify-center gap-5 flex-col lg:flex-row'>
          <img src='/images/prooducts1.jpg' className='w-full lg:w-[43rem] rounded-2xl h-auto lg:h-[48rem] object-cover' />
          <div className='flex flex-col gap-5 text-center lg:text-left px-4 lg:px-0'>
            <h2 className='text-3xl lg:text-5xl text-blue-950 font-extrabold'>
            ...
            <p className='text-base lg:text-2xl text-black'>
      ...
      <section className='w-full flex flex-col lg:flex-row justify-center items-center mt-16 lg:mt-36 px-4 font-montserrat'>
        <div className='flex flex-col gap-8 w-full lg:w-[60%]'>
          <h2 className='text-3xl lg:text-5xl text-blue-950 font-extrabold text-center lg:text-left'>
        ...
        {/* Image Section */}
        <img src='/images/Products2.PNG' className='w-full lg:w-[43rem] mt-10 lg:mt-0 rounded-2xl h-auto lg:h-[48rem] object-cover' />
      </section>
      ...
      <div className="product-page-container flex flex-col lg:flex-row max-w-7xl mx-auto p-6">
        ...
        <div className="main-content flex-1 pr-0 lg:pr-8">
          <h1 className="text-4xl lg:text-6xl font-bold mb-10 lg:mb-14 mt-10 lg:mt-16 text-black font-montserrat text-center lg:text-left">
          ...
          {/* Warranty Section */}
          <h2 className="text-3xl lg:text-5xl font-bold mb-4 text-start text-black font-montserrat">Warranty</h2>
          <p className="text-gray-700 mb-2">
            Marisonia provides a comprehensive 2-year warranty for your assurance.
          </p>
          <h3 className="text-lg lg:text-3xl font-semibold mb-2">Who is Covered?</h3>
